"""
Django settings for deepfake backend project.
"""
...
# 변경
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.35.253', '*']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'deepfake_db'),
...
VIDEO_MAX_DURATION = 30 * 60  # 30분 (초 단위)
VIDEO_ALLOWED_EXTENSIONS = ['mp4', 'mov', 'avi']
